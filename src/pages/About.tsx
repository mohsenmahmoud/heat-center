  ...
  return (
    <>
      <PageHero
        ...
        image={{ src: '/images/pages/about.svg', alt: 'فريق هيت سنتر الهندسي' }}
      />
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="flex flex-col gap-5">
              <span className="text-xs font-bold uppercase tracking-widest text-ember-400">
                قصتنا
              </span>
            ...
            <div className="grid grid-cols-2 gap-6 rounded-3xl border border-white/5 bg-white/[0.03] p-8">
              {stats.map((s) => (
      ...
      <section className="relative bg-ink-900 py-24">
        ...
        <Container className="relative">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-9">
              ...
              <h3 className="mt-5 font-display text-xl font-bold text-white">رسالتنا</h3>
            ...
            <div className="rounded-3xl border border-white/5 bg-white/[0.03] p-9">
              <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-aqua-500/10 text-aqua-400 ring-1 ring-inset ring-aqua-500/20">
                <Compass className="h-5 w-5" />
              </span>
              <h3 className="mt-5 font-display text-xl font-bold text-white">رؤيتنا</h3>
              <p className="mt-3 text-sm leading-relaxed text-ink-300">
        ...
        <Container>
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((v) => (
              <div
                key={v.title}
                className="flex flex-col gap-4 rounded-3xl border border-white/5 bg-white/[0.03] p-7 text-center items-center"
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-ember-500/10 text-ember-400 ring-1 ring-inset ring-ember-500/20">
